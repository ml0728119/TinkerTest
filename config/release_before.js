...
fs.unlink(basePath+'app/src/main/java/com/hxqc/mall/TestDemoActivity2.java')   //删除文件
fs.unlink(basePath+'app/src/main/java/com/hxqc/mall/TestDrawRect.java')   //删除文件
